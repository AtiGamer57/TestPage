    ...
    return (
        <>
            ...
            <div className=" h-svh grid grid-cols-3 gap-8 w-full mb-10">
                ...
                <div className="relative h-full h-96 bg-[url('assets/images/trending2.jpg')] bg-center rounded-xl bg-cover ">
                    <div className=" left-1/2 -translate-x-1/2 absolute bottom-5 w-10/12 my-auto">
                        <p className=" text-gray-200 font-light text-xs mb-3">29.Jun.2024</p>
                        <p className=" text-white font-normal text-md">Richard Norton photo as real as photorealistic renderings</p>
                    </div>
                </div>
                <div className="relative h-full h-96 bg-[url('assets/images/trending3.jpg')] bg-center rounded-xl bg-cover ">
                    <div className=" left-1/2 -translate-x-1/2 absolute bottom-5 w-10/12 my-auto">
                        <p className=" text-gray-200 font-light text-xs mb-3">29.Jun.2024</p>
                        <p className=" text-white font-normal text-md">Richard Norton photo as real as photorealistic renderings</p>
                    </div>
                </div>
                <div className="relative h-full h-96 bg-[url('assets/images/trending4.jpg')] bg-center rounded-xl bg-cover ">
                    <div className=" left-1/2 -translate-x-1/2 absolute bottom-5 w-10/12 my-auto">
                        <p className=" text-gray-200 font-light text-xs mb-3">29.Jun.2024</p>
                        <p className=" text-white font-normal text-md">Richard Norton photo as real as photorealistic renderings</p>
                    </div>
                </div>
                <div className="relative h-full h-96 bg-[url('assets/images/trending5.jpg')] bg-center rounded-xl bg-cover ">
                    <div className=" left-1/2 -translate-x-1/2 absolute bottom-5 w-10/12 my-auto">
                        <p className=" text-gray-200 font-light text-xs mb-3">29.Jun.2024</p>
                        <p className=" text-white font-normal text-md">Richard Norton photo as real as photorealistic renderings</p>
                    </div>
